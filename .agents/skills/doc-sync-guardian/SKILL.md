...
Dokumentasi yang *outdated* (basi) lebih berbahaya daripada tidak ada dokumentasi sama sekali. Di project besar, folder `docs/` adalah "Otak Kedua".
...
- **Beritahu Bos:** Saat melaporkan hasil kerja, sampaikan secara eksplisit: *"Saya juga sudah mengupdate file `docs/database.md` untuk menyesuaikan perubahan tabel ini."*
- **Akurat:** Pastikan diagram Mermaid (jika ada) tidak *broken* sintaksnya setelah diupdate.
